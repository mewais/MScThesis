...
\begin{figure}
    \begin{subfigure}[t]{\textwidth}
        \makebox[\textwidth][c]{\includegraphics[width=1.5\textwidth]{BDIPotential1.png}}
    \end{subfigure}
    \begin{subfigure}[b]{\textwidth}
        \makebox[\textwidth][c]{\includegraphics[width=1.5\textwidth]{BDIPotential2.png}}
    \end{subfigure}
...
\begin{figure}
    \begin{subfigure}[t]{\textwidth}
        \makebox[\textwidth][c]{\includegraphics[width=1.5\textwidth]{DedupPotential1.png}}
    \end{subfigure}
    \begin{subfigure}[b]{\textwidth}
        \makebox[\textwidth][c]{\includegraphics[width=1.5\textwidth]{DedupPotential2.png}}
    \end{subfigure}
