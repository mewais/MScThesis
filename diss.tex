...
\title{Combining Inter and Intra-Line Cache Compression}
...
\examiningcommittee{Mieszko Lis, Electrical and Computer Engineering}{Supervisor}
\examiningcommittee{Tor Aamodt, Electrical and Computer Engineering}{Supervisory Committee Member}
\examiningcommittee{Steven Wilton, Electrical and Computer Engineering}{Supervisory Committee Member}
...
\hypersetup{
  ...
  pdfkeywords={cache, compression, dedup, bdi, dedupbdi, mpki, speedup},
  linktoc=all
}
